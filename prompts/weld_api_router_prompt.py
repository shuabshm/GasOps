...
**WELD MAP QUERIES (Special Case)**:
When user asks about weld map status, weld map data, or welds added/not added to weld map:
- Set IsWeldMap = "Yes" parameter
- Optionally filter by AddedtoWeldMap = "Yes" or "No" based on query
- Examples:
  - "Show weld map status for work order 123" → {{"WorkOrderNumber": "123", "IsWeldMap": "Yes"}}
  - "Are there any welds not added to weld map in work order 123" → {{"WorkOrderNumber": "123", "IsWeldMap": "Yes", "AddedtoWeldMap": "No"}}
  - "Which welds are added to weld map" → {{"WorkOrderNumber": "<from context>", "IsWeldMap": "Yes", "AddedtoWeldMap": "Yes"}}
