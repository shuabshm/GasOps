            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "IsWeldMap": {  # ADD THIS BLOCK
                            "type": "string",
                            "enum": ["Yes", "No"],
                            "description": "Filter for weld map queries. Use 'Yes' when user asks about weld map status, weld map data, or welds added/not added to weld map. Allowed values: Yes, No"
                        },
                        "AddedtoWeldMap": {
                            "type": "string",
                            "enum": ["Yes", "No"],
